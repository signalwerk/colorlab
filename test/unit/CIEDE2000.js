...
describe('CIEDE2000', () => {
    ...
    describe('Delta E of two CIELAB colors', () => {
      ...
      var color1 = new Cielab(test.L1, test.a1, test.b1);
      var color2 = new Cielab(test.L2, test.a2, test.b2);
      expect(CIEDE2000(color1, color2)).to.closeTo(test.dE, 0.0001);
    });

    describe('Delta E of two CIELAB colors with 0', () => {
      var color1 = new Cielab(0,0,0);
      var color2 = new Cielab(0,0,0);
    ...
    describe('Delta E check with testdata', () => {
      ...
      for (var i = 0; i < ciede2000testdata.length; i++ ) {
              ...
              var color1 = new Cielab(ciede2000testdata[i].L1, ciede2000testdata[i].a1, ciede2000testdata[i].b1);
              var color2 = new Cielab(ciede2000testdata[i].L2, ciede2000testdata[i].a2, ciede2000testdata[i].b2);
              expect(CIEDE2000(color1, color2)).to.closeTo(ciede2000testdata[i].dE, 0.0001);
      }
