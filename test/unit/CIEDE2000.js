...
describe('CIEDE2000', () => {
  ...
  describe('Delta E check with testdata', () => {
    ciede2000testdata.forEach((dataset) => {
      const color1 = new Cielab(dataset.L1, dataset.a1, dataset.b1);
      const color2 = new Cielab(dataset.L2, dataset.a2, dataset.b2);
      expect(CIEDE2000(color1, color2)).to.closeTo(dataset.dE, 0.0001);
    });
  });
});
